			...
			<body>
				...
				<form action="modify" id="modifyform" method="post">
					...
					<div class="boardContent">
						<table>
							<tr>
								<th class="boardth"><div class="boardtext">글 본문 수정</div></th><th class="boardpost"><textarea rows="10" cols="54" name="bcontent" class="bcontent"><%=bContent %></textarea>		<!-- 게시글 본문 --></th>
							</tr>
						</table>
					</div>
